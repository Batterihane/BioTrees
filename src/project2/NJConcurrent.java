...
/**
 * Created by Nikolaj on 26-11-2015.
 */
public class NJConcurrent
{
    private double[] r;
    ...
    public HashMap<IntPair, Double> run(String[] leaves, double[][] distances){
        ...
        while(dissimilarities.size() > 3){
            ...
            // Compute r list
            r = new double[numberOfTaxa];
            for (int i = 0; i < numberOfTaxa; i++) {
                Runnable worker = new stepOneWorker(i, dissimilarities.get(i), numberOfTaxa, this);
...
//                System.out.println("numTax: " + numberOfTaxa);
            ...
            // Compute N matrixT
            approxDistances = new double[numberOfTaxa][numberOfTaxa];
            for (int i = 0; i < numberOfTaxa; i++) {
